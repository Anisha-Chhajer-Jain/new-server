...
// create one get route which will retur n state by top GDP .  
app.get('/states/highest-gdp/:count',(req,res)=>{
{
    ...
    const topStates = sorted.slice(0, count);
 
    res.status(200).json({
        message: ` ${count} are the top state`,
        data: topStates
    })
}
})
